            ...
            <table id="transactionsTable" class="min-w-full bg-white border border-gray-300">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 border-b border-gray-300 text-right text-sm font-semibold">Subtotal</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-right text-sm font-semibold">Freight</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-right text-sm font-semibold">Credit</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-right text-sm font-semibold">Total</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">{{ date('d-m-Y', strtotime($transaction->date)) }}</td>
                        <td class="px-6 py-4 border-b border-gray-300 text-right">₹{{ number_format($transaction->subtotal, 2) }}</td>
                        <td class="px-6 py-4 border-b border-gray-300 text-right">₹{{ number_format($transaction->freight, 2) }}</td>
                        <td class="px-6 py-4 border-b border-gray-300 text-right">₹{{ number_format($transaction->credit, 2) }}</td>
                        <td class="px-6 py-4 border-b border-gray-300 text-right">₹{{ number_format($transaction->total, 2) }}</td>
